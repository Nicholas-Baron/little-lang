...
class Location final {
   ...
   public:
	...
	[[nodiscard]] constexpr auto first_line() const noexcept {
		return start_pos.first;
	}
	[[nodiscard]] constexpr auto first_column() const noexcept {
		return start_pos.second;
	}
	[[nodiscard]] constexpr auto last_line() const noexcept {
		return end_pos.first;
	}
	[[nodiscard]] constexpr auto last_column() const noexcept {
...
constexpr bool operator<(const Location & lhs, const Location & rhs) noexcept {
	...
	if (lhs.last_line() != rhs.last_line()) {
